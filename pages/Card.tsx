...
export default function Card() {
	return (
		<>
			...
			<Main>
				<Frame>
					<CardImageIcon src='/img/dev.png' alt='community logo' />
					<CardContainer>
						<CardHeader>
							<HeaderInfo>
								<TitleText>
						...
						<CardBody>
							<CardImage>
								<CardInnerImage src='/img/learn.jpg' alt='card main image' />
								<CardInnerImageIcon src='/img/dev.png' alt='community logo' />
								<AuthorInfo>
									<AuthorImage src='/img/profile.jpg' alt='profile image' />
							...
							<CardDescription>
								<p>Learning React? Start Small.</p>
								<p>
									Can't pry yourself away from the tutorials? The cure is to
									make tiny little experment apps.
								</p>
								<p
									style={{
										color: lightGrey,
